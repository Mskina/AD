...
//Según la documentación (https://docs.oracle.com/javase/8/docs/api/javax/xml/stream/XMLStreamReader.html#getElementText--)
//, después de llamar al método getElementText() el evento toma el valor END_ELEMENT
// y si os fijáis en la documentación https://docs.oracle.com/javase/8/docs/api/javax/xml/stream/XMLStreamReader.html, no está permitido llamar a getAttributeValue() en END_ELEMENT
                    }
                    break;

                case XMLEvent.ATTRIBUTE:

                    if (xmlsr.getAttributeName(0).equals("lang")) {
